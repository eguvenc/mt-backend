...
CREATE TABLE `intakes` (
  ...
  `patientId` char(36) COLLATE utf8mb4_general_ci NOT NULL,
  `medicineId` char(36) COLLATE utf8mb4_general_ci NOT NULL,
  `intakeTime` varchar(8) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `patientId` (`patientId`),
  KEY `medicineId` (`medicineId`),
  CONSTRAINT `intakes_ibfk_1` FOREIGN KEY (`patientId`) REFERENCES `patients` (`id`) ON DELETE CASCADE,
  CONSTRAINT `intakes_ibfk_2` FOREIGN KEY (`medicineId`) REFERENCES `medicines` (`id`) ON DELETE CASCADE
...
INSERT INTO `intakes` VALUES ('1bc383de-252a-11f0-88f0-046c59cc5a29','13e5834d-252a-11f0-88f0-046c59cc5a29','69311441-2528-11f0-88f0-046c59cc5a29','08:00'),('29b6ed46-246b-11f0-80c8-046c59cc5a29','d2d8a99a-2200-11f0-9a18-046c59cc5a29','d2d973ab-2200-11f0-9a18-046c59cc5a29','13:00'),('2a546b48-2375-11f0-923b-046c59cc5a29','d2d8a99a-2200-11f0-9a18-046c59cc5a29','fa845795-2347-11f0-923b-046c59cc5a29','08:00'),('32c23ba1-246e-11f0-80c8-046c59cc5a29','d2d8a99a-2200-11f0-9a18-046c59cc5a29','d2d973ab-2200-11f0-9a18-046c59cc5a29','09:00'),('a0e51b91-2373-11f0-923b-046c59cc5a29','d2d8a7a0-2200-11f0-9a18-046c59cc5a29','d2d97591-2200-11f0-9a18-046c59cc5a29','14:00'),('bca52563-2374-11f0-923b-046c59cc5a29','d2d8a7a0-2200-11f0-9a18-046c59cc5a29','d2d973ab-2200-11f0-9a18-046c59cc5a29','08:00'),('d2da7009-2200-11f0-9a18-046c59cc5a29','d2d8a7a0-2200-11f0-9a18-046c59cc5a29','d2d973ab-2200-11f0-9a18-046c59cc5a29','20:00'),('d2da72e3-2200-11f0-9a18-046c59cc5a29','d2d8a99a-2200-11f0-9a18-046c59cc5a29','d2d973ab-2200-11f0-9a18-046c59cc5a29','20:00'),('dbcdf430-235d-11f0-923b-046c59cc5a29','d2d8a7a0-2200-11f0-9a18-046c59cc5a29','fa845795-2347-11f0-923b-046c59cc5a29','14:00');
...
CREATE TABLE `medicines` (
  ...
  `frequency` enum('once','twice','threeTimes') COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `medicines` VALUES ('69311441-2528-11f0-88f0-046c59cc5a29','Laktuloz','once',1),('d2d973ab-2200-11f0-9a18-046c59cc5a29','Parol','threeTimes',1),('d2d97591-2200-11f0-9a18-046c59cc5a29','Agumentin','twice',0),('fa845795-2347-11f0-923b-046c59cc5a29','Minidol','twice',1);
...
CREATE TABLE `patients` (
  ...
  `ageGroup` enum('infant','adult') COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`),
...
INSERT INTO `patients` VALUES ('13e5834d-252a-11f0-88f0-046c59cc5a29','08438d97-a449-4a93-8169-f14ea4e200ee','male','infant'),('d2d8a7a0-2200-11f0-9a18-046c59cc5a29','c13e550a-60ee-48d5-bf6e-ed29310640b2','female','adult'),('d2d8a99a-2200-11f0-9a18-046c59cc5a29','a399797c-1748-4161-a8cd-2e0f9828840b','male','infant');
...
--
-- Dumping routines for database 'pmm'
--
...
-- Dump completed on 2025-04-29 23:46:01
