...
namespace Intakes\Handler\MaleInfants;
...
class FindAllByPagingHandler implements RequestHandlerInterface
{
    ...
    /**
     * @OA\Get(
     *   path="/intakes/maleInfants/findAllByPaging",
     *   tags={"Intakes"},
     ...
     *     @OA\JsonContent(ref="#/components/schemas/IntakesFindAllByPaging"),
     *   ),
     *   @OA\Response(
     *      response=404,
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        $get['maleInfants'] = true; // male infants switch

        // https://docs.laminas.dev/tutorials/pagination/
        $paginator = $this->intakeModel->findAllByPaging($get);
